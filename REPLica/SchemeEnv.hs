...
makeFunc :: Maybe String -> Env -> [LispVal] -> [LispVal] -> ErrorT LispError IO LispVal
makeFunc varargs env params body = return $ Func (map show params) varargs body env

makeNormalFunc :: Env -> [LispVal] -> [LispVal] -> ErrorT LispError IO LispVal
makeNormalFunc = makeFunc Nothing

makeVarFunc :: LispVal -> Env -> [LispVal] -> [LispVal] -> ErrorT LispError IO LispVal
makeVarFunc = makeFunc . Just . show
