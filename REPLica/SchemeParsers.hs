...
parseExpr = try parseSingleLineCommentExpr <|> try parseList <|> parseDottedList <|> try parseVector <|> try parseCharacter <|> parseString <|> try parseComplex <|> try parseFloat <|> try parseRatio <|> try parseNumber <|> parseBool <|> parseQuoted <|> parseQuasiQuoted <|> parseUnQuote <|> parseAtom
